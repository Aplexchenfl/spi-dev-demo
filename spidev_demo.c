...
static int all_uart_clk_en = (1 << 5) | (1 << 4) | (1 << 3) | (1 << 2) | (1 << 1) | 1;
static int wk24xx_command1 = WK24XX_WRITE_REG | WK24XX_GENA;
static int wk24xx_command2 = WK24XX_READ_REG | WK24XX_GENA;
static int wk24xx_command_read_grst = WK24XX_READ_REG | WK24XX_GRST;

static int wk24xx_writedata1 = 0x0;
static int wk24xx_readdata1 = 0x0;
static int wk24xx_readdata2 = 0x0;

static void transfer(int fd)
{
    int ret;
    uint8_t tx[] = {    //要发送的数据数组
        wk24xx_command_read_grst, wk24xx_readdata1, wk24xx_readdata2
    };
